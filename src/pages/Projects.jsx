...
<p className="text-sm md:text-lg lg:text-xl">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Totam dolores suscipit cupiditate voluptates consequatur possimus assumenda quos et expedita adipisci. Quo assumenda ipsam nisi voluptatem sapiente nostrum corporis, quis quaerat!</p>
   <div className="flex gap-4 mt-4">
   <a target="_blank" rel="noopener"  className="cursor-pointer bg-orange-500 hover:bg-orange-700 text-white font-semibold py-2 px-4 rounded shadow inline-block text-sm md:text-lg lg:text-xl" href="https://travel-app-vert-five.vercel.app/itinerary/13">Hosted site</a>
...
<div className="flex items-end flex-col">
<p className="px-4 text-sm sm:text-xs md:text-lg lg:text-xl mt-4">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Totam dolores suscipit cupiditate voluptates consequatur possimus assumenda quos et expedita adipisci. Quo assumenda ipsam nisi voluptatem sapiente nostrum corporis, quis quaerat!</p>
   <div className="flex gap-4 mt-4">
   <a target="_blank" rel="noopener"  className="cursor-pointer bg-blue-500 hover:bg-blue-700 text-white font-semibold py-2 px-4 rounded shadow inline-block text-sm md:text-lg lg:text-xl" href="https://www.youtube.com/watch?v=f2mnA_EE71k">Video Demo</a>
...
<div className="flex items-end flex-col">
<p className="text-md md:text-lg lg:text-xl">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Totam dolores suscipit cupiditate voluptates consequatur possimus assumenda quos et expedita adipisci. Quo assumenda ipsam nisi voluptatem sapiente nostrum corporis, quis quaerat!</p>
   <div className="flex gap-4 mt-4">
   <a target="_blank" rel="noopener"  className="cursor-pointer bg-pink-500 hover:bg-pink-700 text-white font-semibold py-2 px-4 rounded shadow inline-block text-sm md:text-lg lg:text-xl" href="https://alexstraton.github.io/Hotel-webpage/">Hosted site</a>
  ...
  <div className="border-4 border-red-300 m-12 md:m-24 lg:m-32 rounded-xl ">
    <h1 className="text-red-600 md:text-3xl lg:text-4xl text-2xl font-extralight p-2">NC News</h1>
...
<p className="text-md md:text-lg lg:text-xl">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Totam dolores suscipit cupiditate voluptates consequatur possimus assumenda quos et expedita adipisci. Quo assumenda ipsam nisi voluptatem sapiente nostrum corporis, quis quaerat!</p>
   <div className="flex gap-4 mt-4">
   <a target="_blank" rel="noopener"  className="cursor-pointer bg-red-500 hover:bg-red-700 text-white font-semibold py-2 px-4 rounded shadow inline-block text-sm md:text-lg lg:text-xl" href="http://localhost:5173/Projects">Hosted site</a>
