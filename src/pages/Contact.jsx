...
export default function Contact() {
  ...
  <h1 className="mt-24 text-black text-6xl mx-auto p-8 font-extralight">Contact</h1>
<div className="flex flex-col items-end">
    ...
    className="flex items-center gap-2 cursor-pointer text-black-300 font-thin hover:text-green-600 hover:text-md  hover:border-b-2 hover:border-black transition-all duration-600 ease-in-out px-3 transition duration-600 ease-in-out text-xs font-small">
