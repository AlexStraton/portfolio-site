...
<p>- Worked using TDD first practices</p>
    ...
    <aside className="col-span-1 flex flex-col h-full p-6">
...
<section >
  <div className="p-8 text-2xl flex flex-col bg-gray-200 border-2 border-gray-300 m-2 md:m-4 lg:m-8 rounded-xl ">
  <h2 className="text-2xl mb-4">Languages Spoken</h2>
